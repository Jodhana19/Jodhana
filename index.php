...
<body class="p-[0px] m-[0px]">
    ...
    <div class="video-container ">
        ...
        <div class="h-[100%] w-[100vw]  lg:w-[65vw]  md:w-[75vw] font-black  bg-slate-700  opacity-60 min-h-[100px] pt-7  pb-0   md:skew-x-[-9deg] sm: skew-x-[0deg]  before: origin-top-right ">
            ...
            <div class="w-[60%]  pt-[2%] text-justify m-auto md:-skew-x-[-9deg]">
                
                <div class="text-center mb-2 text-[28px]  md:text-4xl lg:text-6xl text-white tracking-wide  ">Our Website is Coming Soon</div>
                <p class="mt-7 mb-16 lg:text-xl text-sm md:text-lg text-white font-medium pt-0 md:p-0 ">We're working hard to finish the development of this site. Sign up below to
                    receive updates and to be notified when we launch!</p>
                    <form action="ver.php" method="post">
                        <div class="md:flex md:gap-1 ">
                        <div><input type="email" name="email" class="p-2 my-2 md:my-0 w-[240px] bg-transparent border-white border-2 text-white  lg:w-[300px] -skew-lg-x-12 placeholder:text-white font-extralight" placeholder="Email"></div>
                        <div class="md:ms-8 mx-[40px] md:my-0 ">
                            <button type="submit"  class="border-2 border-white px-14 py-1 hel text-white  ">
                                Submit
                                <div class="right-vert-line"></div>
                                <div class="top-vert-line"></div>
                                <div class="bottom-vert-line"></div>
